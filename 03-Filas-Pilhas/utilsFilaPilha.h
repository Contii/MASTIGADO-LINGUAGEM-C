...
# include "structs.h"
# include "Fila/TAD_Fila.h"

/////////////////// EXERCICIO 1 STRUCT NGE
struct infoNGE{
   int       *info;
   int       *nge;
};

typedef struct infoNGE  InfoNGE;
typedef InfoNGE*         pInfoNGE;
...
/* --------------------------------- TIPO DE DADO STRUCT ----------------------------- */
/* ----------------------------------------------------------------------------------- */
//////////////////////////////////////////////////////////////////////////////////////////////EXERCICIO 1 IMPRESSÃO
void    imprimeNge(struct infoNGE* info1){
   int *p1 = (struct infoNGE*) info1->info;
   int *p2 = (struct infoNGE*) info1->nge;
   printf("|%d/%d|  ", *p1,*p2);
}
/* ----------------------------------------------------------------------------------- */
/* ------------------------------------ OPERAÇOES ------------------------------------ */
...
char bemFormada (char sequencia[]){///////////////////////// exercicio 4
  int cont = 0;
  int i = 0;
  char S = 'S';
  char N = 'N';
  while((cont >= 0) && (sequencia[i] != NULL)){
    if(sequencia[i] == 'E'){
        cont++;
    }
    else
