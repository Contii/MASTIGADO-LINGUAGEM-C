# Pequenos programas em linguagem C, contendo a construção comentada das principais estruturas de dados. Tudo isso utilizando alocação dinâmica de memória e ponteiros para VOID.
