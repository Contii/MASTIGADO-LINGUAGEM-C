...
/* Perceba como a definição de PDATA1(usando typedef) ficou mais simples do que PDATA2 */
...
/* Esse algoritmo é mais complexo, provavelmente você também terá essa dificuldade,
